...
消息是指飞书内的即时消息，用于满足企业或用户日常工作中的沟通需要、帮助团队提升信息处理效率和顺畅交流               

飞书开放平台服务端API地址: https://open.feishu.cn/document/server-docs/im-v1/introduction                         
发送消息接口API地址: https://open.feishu.cn/document/server-docs/im-v1/message/create                
